...
│   │   ├── TrendChart.tsx     # Historical budget trends (generalized for departments, revenue sources, and subcategories)
│   │   ├── LineItemTrend.tsx  # Subcategory trend drill-down within a department or revenue source
